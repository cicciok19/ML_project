...
train_generator = train_dataset.generate(batch_size=batch_size,
                                         ...
                                         translate=False, # Randomly translate by 5-50 pixels horizontally and 3-30 pixels vertically with probability 0.5
                                         scale=False, # Randomly scale between 0.75 and 1.3 with probability 0.5
